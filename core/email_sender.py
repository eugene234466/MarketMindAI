  ...
  <tr>
    <td style="padding:32px 30px 20px;">
      ...
      <p style="color:#555;font-size:14px;line-height:1.7;margin:0 0 24px;">
        We received a request to reset the password for your MarketMind AI account.
      ...
      <p style="color:#999;font-size:12px;margin:0;">
        ...
        <a href="{reset_url}" style="color:#00a8c6;">{reset_url}</a>
      </p>
    </td>
  </tr>
  <tr>
...
"""
        ...
        send_via_smtp(msg, recipient_email)
        print(f"[Email] Password reset sent to {recipient_email}")
        return True
    except Exception as e:
